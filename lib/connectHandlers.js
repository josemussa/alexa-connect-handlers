(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("connectHandlers", [], factory);
	else if(typeof exports === 'object')
		exports["connectHandlers"] = factory();
	else
		root["connectHandlers"] = factory();
})(this, function() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__connectHandlers__ = __webpack_require__(35);


/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0__connectHandlers__["a" /* default */]);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = createConnect;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_isFunction__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_isObject__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_mapValues__ = __webpack_require__(39);
...
const mapExtraArguments = (extraArguments, context) =>
    (__WEBPACK_IMPORTED_MODULE_1_lodash_isObject___default.a(extraArguments)
        ? __WEBPACK_IMPORTED_MODULE_2_lodash_mapValues___default.a(
            extraArguments,
            value => (__WEBPACK_IMPORTED_MODULE_0_lodash_isFunction___default.a(value) ? params => value(params)(context) : value),
        )
        : {});

function createConnect(handler, props) {
    return function connect() {
        const context = this;
        const args = __WEBPACK_IMPORTED_MODULE_2_lodash_mapValues___default.a(context, value => (__WEBPACK_IMPORTED_MODULE_0_lodash_isFunction___default.a(value) ? value.bind(context) : value));
...
//# sourceMappingURL=connectHandlers.js.map